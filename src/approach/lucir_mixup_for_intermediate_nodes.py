...
class Appr(Inc_Learning_Appr):
    ...
    def train_loop(self, t, trn_loader, val_loader, args, tst_loader):
        data_method = args.datasets
        # print(data_method[0][-4:])
        # print(c)
    ...
    # add exemplars to train_loader
        ...
        # num_classes = 50#len(trn_loader.dataset.targets.unique())
        ...
        if t >= 0:
            ...
            tune_epochs = 100
            # if data_method[0][-4:] == 'conv' and t==0:
            #     tune_epochs = 0
            #     print("conv method base task tuning wont happen")
